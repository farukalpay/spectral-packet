...
curl "http://127.0.0.1:8000/workflow/guide?input_kind=profile-table-file"
curl http://127.0.0.1:8000/health
curl http://127.0.0.1:8000/status
curl http://127.0.0.1:8000/validate-install
```
...
- profile-table workflows: inspect, report, analyze, compress, compare, inverse fit, and SQL-backed report/analyze/compress/fit
