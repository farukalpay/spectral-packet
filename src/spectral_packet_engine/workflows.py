...
def fit_gaussian_packet_to_profile_table_from_database_query(
    ...
    *,
    ...
    return fit_gaussian_packet_to_profile_table(
        materialized.table,
        initial_guess=initial_guess,
        num_modes=num_modes,
        quadrature_points=quadrature_points,
...
def materialize_profile_table_from_database_query(
    ...
    *,
    ...
    layout = profile_table_layout_from_tabular_dataset(
        result.dataset,
...
def analyze_profile_table_from_database_query(
    ...
    *,
    ...
    return analyze_profile_table_spectra(
        materialized.table,
        num_modes=num_modes,
        device=device,
...
def train_modal_surrogate_from_database_query(
    ...
    *,
    ...
    return train_modal_surrogate_on_profile_table(
        materialized.table,
        backend=backend,
        num_modes=num_modes,
        normalize_each_profile=normalize_each_profile,
...
def evaluate_modal_surrogate_from_database_query(
    ...
    *,
    ...
    return evaluate_modal_surrogate_on_profile_table(
        materialized.table,
        backend=backend,
        num_modes=num_modes,
        normalize_each_profile=normalize_each_profile,
...
def simulate_packet_sweep(
    ...
    *,
    ...
    shared_times = torch.as_tensor(times, dtype=torch.float64)
