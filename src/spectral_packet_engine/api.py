...
def create_api_app():
    ...
    def workflow_guide(input_kind: Literal["profile-table-file", "profile-table-sql"] = "profile-table-file"):
        return to_serializable(guide_workflow(surface="api", input_kind=input_kind))
