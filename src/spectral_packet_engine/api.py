...
def create_api_app():
    ...
    app = FastAPI(
        title="Spectral Packet Engine API",
        version="0.2.0",
        description=(
            "Optional HTTP interface for bounded-domain modal simulation, profile compression, "
            "inverse reconstruction, SQL-backed workflows, and backend-aware modal surrogate workflows."
        ),
    )
